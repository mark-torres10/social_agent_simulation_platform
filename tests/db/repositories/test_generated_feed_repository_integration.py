...
class TestSQLiteGeneratedFeedRepositoryIntegration:
    ...
    def test_create_or_update_generated_feed_updates_existing_feed(self, temp_db):
        ...
        updated_feed = GeneratedFeed(
            ...
            turn_number=1,
            agent_handle="test.bsky.social",
            post_uris=["at://did:plc:test1/app.bsky.feed.post/post1", "at://did:plc:test2/app.bsky.feed.post/post2"],
        ...
        assert retrieved_feed.post_uris == ["at://did:plc:test1/app.bsky.feed.post/post1", "at://did:plc:test2/app.bsky.feed.post/post2"]
    
    def test_get_generated_feed_raises_value_error_for_nonexistent_composite_key(self, temp_db):
    ...
    def test_list_all_generated_feeds_retrieves_all_feeds(self, temp_db):
        ...
        assert feed_dict[("user2.bsky.social", "run_2", 2)].post_uris == ["at://did:plc:test2/app.bsky.feed.post/post2"]
        assert feed_dict[("user3.bsky.social", "run_3", 3)].created_at == "2024-01-03T00:00:00Z"
    ...
    def test_multiple_feeds_with_same_agent_handle_but_different_run_id_turn_number(self, temp_db):
    ...
    def test_generated_feed_with_multiple_post_uris(self, temp_db):
        ...
        post_uris = [
            f"at://did:plc:test{i}/app.bsky.feed.post/post{i}"
            for i in range(1, 11)
        ]
        feed = GeneratedFeed(
